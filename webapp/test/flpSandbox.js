		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte de Vacunacion",
									"targetURL": "#testreetable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testreetable-display": {
								"semanticObject": "testreetable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testreetable",
									"url": sap.ui.require.toUrl("testreetable")
								}
							}
						}
					}
